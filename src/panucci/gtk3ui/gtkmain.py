...
class PanucciGUI(object):
    ...
    def create_actions(self):
        ...
        self.action_play_mode_single.join_group(self.action_play_mode_all)
        ...
        self.action_play_mode_random.join_group(self.action_play_mode_all)
        ...
        self.action_play_mode_repeat.join_group(self.action_play_mode_all)
...
class PlayerTab(ObservableService, gtk.HBox):
    ...
    def make_player_tab(self):
        ...
        metadata_vbox.pack_start(self.album_label, False, False, 0)
        separator = gtk.Label("")
        separator.set_size_request(-1, 10)
        metadata_vbox.pack_start(separator, False, False, 0)
        ...
        metadata_vbox.pack_start(self.title_label, False, False, 0)
        metadata_vbox.pack_start(gtk.Image(), True, True, 0)
        metadata_hbox.pack_start( metadata_vbox, True, True, 0)

        progress_eventbox = gtk.EventBox()
        progress_eventbox.set_events(gdk.EventMask.BUTTON_PRESS_MASK)
        ...
        main_vbox.add( progress_eventbox)
